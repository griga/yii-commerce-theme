...
<li class="dropdown">
    ...
    <ul class="dropdown-menu dropdown-user">
        <li><a href="/admin/user/manage/update/<?= user()->id ?>"><i class="glyphicon glyphicon-user"></i> <?= t('User Profile'); ?></a>
        </li>
        <li class="divider"></li>
        <li><a href="<?= app()->createUrl('site/logout') ?>"><i class="glyphicon glyphicon-log-out"></i> <?= t('Logout')?></a>
        </li>
    </ul>
</li>
</ul>
